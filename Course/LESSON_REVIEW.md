...
| 5 | **Deck density.** Originally written as "46 to 66 slides per lesson against roughly 80 lecture minutes: 35–50 slides an hour, where CLAUDE.md says 25–30". | **Measured 29 August 2026, and the original claim was wrong.** Those 80 minutes were an estimate; each lesson's own plan budgets 99 to 160 minutes of lecture once notebooks and the break are removed. Against the plans, the course runs at **26.5 slides per lecture-hour**, inside the band. Only lessons 8, 9 and 10 exceed it, at 31.7, 33.9 and 32.8, and four lessons sit under 25 — lesson 5 at 19.2 and lesson 4 at 20.2. **What is worth deciding is not the lesson average but two segments**: lesson 9's "Initialisation, optimisers, regularisation" at 12 slides in 13 minutes (55/h) and lesson 4's "Cost-optimal thresholds; multiclass; homework" at 9 in 10 (54/h). A minute a slide. **Closed 12 September 2026: left as it is, by the instructor's decision, and the measurement behind it is worth keeping.** Four of lesson 9's twelve slides are figures — one word of body each — so counting slides overstates that segment: by words it is about seventeen minutes of material in a thirteen-minute box, long by four rather than by half. Nothing in it is spare (initialisation, optimisers and regularisation are all used by notebook 3, which follows immediately), merging a claim onto its figure is what `build.py`'s overflow check exists to reject, and no redistribution of minutes helps because the lesson runs at 36.8 slides per lecture-hour however the minutes are spread. The remedy, if one is ever wanted, is in the room and not in the deck. |
