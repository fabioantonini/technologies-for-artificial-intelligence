...
test set exists**, and why the rule about splitting before doing anything else is not
bureaucratic caution but the only thing standing between you and a meaningless number.

Everything in Lesson 5 elaborates this paragraph.
...
decision uses the training portion only. See Section 2.2 for why this is the load-
bearing step.
