...
MCAR, MAR or would be MNAR. Use that knowledge to check your intuition against
...
**Tukey's IQR rule.** Let $Q_1, Q_3$ be the first and third quartiles and
...
model's AUC by a fraction of a point, which is itself a legitimate result, not
